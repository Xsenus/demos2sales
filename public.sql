...
FROM actions a;
-- 03_reset_empty_demo_with_two_managers.sql
-- Обнуляет демо-базу: очищает действия и справочники, создает директора и двух менеджеров Казани без действий.
-- Выполнять после подключения к базе demo_calc.
