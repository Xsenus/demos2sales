...
- Поля `Время работы демонстратором` и `Время на мед. и тех. осмотр, подписание актов, забор льда` теперь задаются менеджером в карточке демонстрации; из бизнес-настроек мед./тех. время убрано.
